...
def check_out_domain(cururl, curuser, curpass, domain_id):
  # Get a collection of domains(will need to work with pages later if results > 20)
...
def main():
  ...
  for domain in domain_list:
    ...
    if is_free_for_use == 1 and is_type_vlan == 1:
      ...
      check_out_domain(foreman_api, username, password, domain['id'])
      ...
      print "Domain %s is either the wrong type or in use" % domain['name']
      continue
